          ...
          <div className="row mb-3">
            <div className="col-md-4">
              ...
              <div className="row small">
                ...
                <div className="col-md-12">
                <p className="text-muted"> <a style={{ color: 'var(--text-color)', textDecoration: 'none', transition:'background 0.3s ease-in-out, color 0.6s ease-in-out' }} href="https://github.com/Yetiiii25/PersonalWebsiteConversionReact" target="_blank" rel="noreferrer">
